...
class plgVMPaymentSystempay extends vmPSPlugin {
	...
	function plgVmConfirmedOrder ($cart, $order) {
		...
		$form .= '<input type="image" name="submit" src="' . JURI::base (TRUE) . '/images/stories/virtuemart/payment/' . $this->_name . '.png" alt="' . JText::_ ('VMPAYMENT_' . $this->_name . '_BTN_ALT') . '" title="' . JText::_ ('VMPAYMENT_SYSTEMPAY_BTN_ALT') . '"/>';
	...
	function plgVmOnPaymentResponseReceived (&$html) {
		...
		if ($order_status_code == 'P') {
			...
			vmWarn (JText::_ ('VMPAYMENT_' . $this->_name . '_SHOP_TO_PROD_INFO') . '<a href="https://paiement.systempay.fr/html/faq/prod" target="_blank">https://paiement.systempay.fr/html/faq/prod</a>', '');
		}
