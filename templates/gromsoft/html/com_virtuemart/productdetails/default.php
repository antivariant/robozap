...
//<![CDATA[
      ...
      jQuery.noConflict()(function($){
      	$('.customer-reviews, .product-files').css('display','none');
  		})(jQuery);

      function activateTab(pageId, clrId) {
      	var j = jQuery.noConflict();
      	j('.customer-reviews, .product-files, .product-description').css('display','none');
      	j(pageId).css('display','block');
      	j('.tabs-line').css('background-color',j(clrId).css('background-color'));
      }
...
<?php
if (!empty($this->product->customfieldsSorted['product-promo'])) {
    	$this->position='product-promo';
...
?>
	...
	<div class="prod-detail floatright">
...
//		}  // Add To Cart Button END
   ...
   <?php
	...
	?>
        <div class="short-descr-head">Основные характеристики</div>
        ...
        <div class="short-descr-bottom"></div>
	<?php
	...
	?>
			...
			if (VmConfig::get('ask_question', 1) == 1) {
			    ?>
			    		<div class="ask-a-question">
			    		    <a class="ask-a-question" href="<?php echo $this->askquestion_url ?>" ><?php //echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?><div class="ask-icon"></div></a>
		...
		echo $this->linkIcon($link . '&format=pdf', 'COM_VIRTUEMART_PDF', 'icon-pdf', 'pdf_button_enable', false);
	    }
	    echo $this->linkIcon($link . '&print=1', 'COM_VIRTUEMART_PRINT', 'icon-printer', 'show_printicon');
	    echo $this->linkIcon($MailLink, 'COM_VIRTUEMART_EMAIL', 'icon-email', 'show_emailfriend');
	    ?>
    ...
    <ul class="tabs">
    	<li id="descr-tab"><a href="javascript:activateTab('.product-description','#descr-tab')">Описание</a></li>
    	<li id="review-tab"><a href="javascript:activateTab('.customer-reviews', '#review-tab')">Отзывы</a></li>
    	<li id="files-tab"><a href="javascript:activateTab('.product-files','#files-tab')">Файлы</a></li>
    </ul>
