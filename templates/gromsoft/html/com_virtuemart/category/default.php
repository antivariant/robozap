...
<h1 class="vit-catname"><?php echo $this->category->category_name; ?></h1>
		...
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>">
			<div class="spacer">
				<a title="<?php echo $product->link ?>" rel="vm-additional-images" href="<?php echo $product->link; ?>">
					<h2 class="vit-prodname"><?php echo $product->product_name; ?></h2>
 					...
 					<?php
						...
						<div class="stock-level">
							...
							<span class="stock-level-value"> <?php echo $product->stock->stock_tip ?></span>
						</div>
						<?php } ?>
						...
						<div class="product-promo">
							<?php
							if (!empty($product->customfieldsSorted['product-promo'])) {
							    	$product->position='product-promo';
						...
						//RATING
							...
							<!--span class="vote"><?php echo JText::_('COM_VIRTUEMART_RATING') . ' ' . JText::_('COM_VIRTUEMART_UNRATED') ?></span-->
							    ...
							    $ratingwidth = $product->rating->rating * 24; //I don't use round as percetntage with works perfect, as for me
							  ?>
					...
					<div class="vit-product-price" id="productPrice<?php echo $product->virtuemart_product_id ?>">
						Цена:
						<?php
						...
						<p class="vit-product-desc">
							<?php echo shopFunctionsF::limitStringByWord ($product->product_s_desc, 312, '...') ?>
						</p>
