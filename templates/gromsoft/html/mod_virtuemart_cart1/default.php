...
<?php echo  $data->cart_show1; ?>
<div><span class="total_products"><?php echo  $data->totalProductTxt ?></span>&nbsp;<span class="total"><?php if ($data->totalProduct and $show_price) echo  "(".$data->billTotal.")"; ?></span></div>
</a>
